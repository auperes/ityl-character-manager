...
namespace Ityl::DataModel::Converters
{
    ...
    Ui::Models::FilteringType Converters::convertFilteringType(const QString &type)
    {
        if (type == "Tous")
            return Ui::Models::FilteringType::None;
        if (type == QString("group"))
            return Ui::Models::FilteringType::Group;
        if (type == QString("ethnie"))
            return Ui::Models::FilteringType::Ethnie;
        if (type == QString("nation"))
            return Ui::Models::FilteringType::Nation;
