...
SkillUiModel::SkillUiModel(const QString &skillName, const QList<Skill> &skillValues, QObject *parent)
    : QObject (parent)
...
QString SkillUiModel::createSkillValuesStringFromSkills(const QList<Skill> &skills) const
{
    QString skillDetail;
